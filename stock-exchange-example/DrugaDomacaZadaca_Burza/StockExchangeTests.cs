...
namespace DrugaDomacaZadaca_Burza.Test
{
    [TestClass]
    public class DrugaDomacaZadaca_Burza
    {
        ...
        public void Test_AddStockToIndex_Simple()
        {
            ...
            Assert.IsTrue(_stockExchange.IsStockPartOfIndex(indexName, firstStockName));
            Assert.IsTrue(_stockExchange.IsStockPartOfIndex(indexName, secondStockName));
            Assert.IsTrue(_stockExchange.IsStockPartOfIndex(indexName, thirdStockName));
        ...
        public void Test_AddStockToPortfolio_Complicated()
        {
            ...
            Assert.IsFalse(_stockExchange.IsStockPartOfPortfolio(portfelj1, dionica1));   // treba baciti false, tak je Vanjak rekao (iako dionica ne postoji na burzi)
        }
